...
func (t Training) meanSpeed() float64 {
	dis := t.distance()
	if dis!=0{
	durationInSeconds := float64(t.Duration) / float64(time.Second)
	return dis / durationInSeconds
	}else{
		return 0
	}
}
...
func (t Training) TrainingInfo() InfoMessage {
	var info InfoMessage = InfoMessage{TrainingType: t.TrainingType, Duration: t.Duration, Distance: t.distance(), Speed: t.meanSpeed(), Calories: t.Calories()}
	return info
}
...
func (r Running) Calories() float64 {
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * float64(r.Training.Weight) / MInKm * r.Training.Duration.Hours() * MinInHours)
}

// TrainingInfo возвращает структуру InfoMessage с информацией о проведенной тренировке.
// Это переопределенный метод TrainingInfo() из Training.
func (r Running) TrainingInfo() InfoMessage {
	var info InfoMessage = InfoMessage{TrainingType: r.TrainingType, Duration: r.Duration, Distance: r.distance(), Speed: r.meanSpeed(), Calories: r.Calories()}
	return info
...
func (w Walking) Calories() float64 {
	speed := w.meanSpeed() * MInKm
	return ((CaloriesWeightMultiplier*float64(w.Training.Weight) + (speed*speed/float64(w.Height))*CaloriesSpeedHeightMultiplier*float64(w.Training.Weight)) * w.Training.Duration.Hours() * MinInHours)
}

// TrainingInfo возвращает структуру InfoMessage с информацией о проведенной тренировке.
// Это переопределенный метод TrainingInfo() из Training.
func (w Walking) TrainingInfo() InfoMessage {
	var info InfoMessage = InfoMessage{TrainingType: w.TrainingType, Duration: w.Duration, Distance: w.distance(), Speed: w.meanSpeed() * MInKm, Calories: w.Calories()}
	return info
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	if s.TrainingInfo().Duration.Hours()!=0{
		return float64(s.LengthPool*s.CountPool) / float64(MInKm) / s.TrainingInfo().Duration.Hours()
	}else{
		return 0
	}
}
...
func (s Swimming) Calories() float64 {
	return (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * float64(s.Training.Weight) * s.Training.Duration.Hours()
}

// TrainingInfo returns info about swimming training.
// Это переопределенный метод TrainingInfo() из Training.
func (s Swimming) TrainingInfo() InfoMessage {
	var info InfoMessage = InfoMessage{TrainingType: s.TrainingType, Duration: s.Duration, Distance: s.distance(), Speed: s.meanSpeed() * MInKm, Calories: s.Calories()}
	return info
